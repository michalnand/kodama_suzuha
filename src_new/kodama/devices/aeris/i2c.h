...
template <unsigned char port_name, unsigned char sda_pin, unsigned char scl_pin, unsigned char bus_speed = 5> class TI2C // : public CI2C_Interface
{
  private:
    TGpio<port_name, sda_pin, GPIO_MODE_IN_FLOATING> sda;
    TGpio<port_name, scl_pin, GPIO_MODE_IN_FLOATING> scl;
